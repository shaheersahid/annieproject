    ...
    <div class="navbar-header">
        ...
        <div class="navbar-logo-box">
            <a href="{{ route('admin.dashboard') }}" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="{{ seo_alt('Smart Comfort Deals logo') }}" style="max-height: 30px; width: auto;">
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="{{ seo_alt('Smart Comfort Deals logo') }}" style="max-height: 45px; width: auto; object-fit: contain;">
                </span>
            </a>
