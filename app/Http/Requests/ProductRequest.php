...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'affiliate_platform' => ['nullable', Rule::in(['none', 'amazon', 'temu', 'aliexpress', 'both', 'all'])],
            'amazon_url' => ['nullable', 'url', 'max:2048'],
            'temu_url' => ['nullable', 'url', 'max:2048'],
            'aliexpress_url' => ['nullable', 'url', 'max:2048'],
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            ...
            'is_latest' => filter_var($this->input('is_latest', false), FILTER_VALIDATE_BOOLEAN),
            'is_reel' => filter_var($this->input('is_reel', false), FILTER_VALIDATE_BOOLEAN)
                || filled($this->input('tiktok_url')),
