...
class AffiliateDemoProductSeeder extends Seeder
{
    public function run(): void
    {
        $seller = Seller::firstOrCreate(
            ...
            [
                ...
                'short_description' => 'Affiliate picks for comfort, home, office, and daily-use accessories.',
                'is_active' => true,
            ]
        );
        ...
        $products = [
            ...
            ['Women Oversized UV400 Sunglasses', 'Sunglasses', 'Annie Finds', 'frame', 'temu', 'cartier-premium-half-frame.png', 4.3, ['Fashion-forward shape', 'UV400 style listing'], ['Retailer color can vary']],
            ['Flexible TR90 Eyeglass Frames', 'Eyeglass Frames', 'Astra', 'frame', 'amazon', 'tomford-men-frame.png', 4.5, ['Flexible frame material', 'Prescription-ready style'], ['Lens fitting handled by retailer or optician']],
            ...
            ['Kids Blue Light Glasses', 'Blue Light Glasses', 'Smart Comfort Finds', 'lens', 'both', 'rayban-premium-frame.png', 4.4, ['Child-friendly style', 'Screen-time focused'], ['Sizing needs careful checking']],
            ['Magnetic Clip On Sunglasses Frame', 'Eyeglass Frames', 'Annie Finds', 'frame', 'amazon', 'cartier-transition-glasses.png', 4.1, ['Two-in-one style', 'Useful for indoor and outdoor use'], ['Magnet alignment depends on model']],
            ['Eyeglass Repair Kit with Screws', 'Lens Accessories', 'Smart Comfort Finds', 'accessory', 'temu', 'glasses-cleaning-kit.png', 4.3, ['Handy home repair kit', 'Small and easy to store'], ['Tiny parts require careful handling']],
            ['Microfiber Lens Cleaning Cloth Set', 'Cleaning Kits', 'Annie Finds', 'accessory', 'both', 'glasses-cleaning-kit.png', 4.8, ['Useful for glasses and screens', 'Low-cost add-on item'], ['Wash before reuse for best results']],
    ...
    private function shortDescription(string $category): string
    {
        return match ($category) {
            ...
            'Sunglasses' => 'Affiliate pick for outdoor use, driving, and casual wear.',
            ...
            'Lens Accessories', 'Cleaning Kits' => 'Affiliate pick for glasses care, storage, and maintenance.',
            default => 'Affiliate product pick for Smart Comfort Finds.',
        };
    }
}
